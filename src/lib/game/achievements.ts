...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'special-bomb',
    title: 'Sprengmeister',
    description: 'Verdiene deine erste Bombe (Combo x3).',
    icon: 'fa-bomb',
    tier: 'bronze',
    test: ({ stats }) => stats.highestCombo >= 3,
  },
  {
    ...
    description: 'Verdiene deinen ersten Hammer (Combo x5).',
    icon: 'fa-hammer',
    tier: 'silver',
    test: ({ stats }) => stats.highestCombo >= 5,
  },
  {
    id: 'special-joker',
    title: 'Magier',
    description: 'Verdiene deinen ersten Joker (Combo x7).',
    icon: 'fa-wand-magic-sparkles',
    tier: 'gold',
    test: ({ stats }) => stats.highestCombo >= 7,
  },
  {
    id: 'mode-explorer',
