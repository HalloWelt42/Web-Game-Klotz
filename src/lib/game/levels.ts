...
export const LEVELS: Level[] = [
  ...
  },
  {
    id: 'level-4',
    title: 'Mauerbauer',
    description: '160 Punkte in 25 Zügen, drei Blocks und zwei Eis.',
    goal: { points: 160 },
    movesLimit: 25,
    blockCount: 3,
    iceCount: 2,
  ...
  },
  {
    id: 'level-6',
    title: 'Gut gemischt',
    description: '180 Punkte in 28 Zügen.',
    goal: { points: 180 },
    movesLimit: 28,
    blockCount: 4,
    iceCount: 3,
  ...
  },
  {
    ...
    description: '220 Punkte in 32 Zügen, viele Hindernisse.',
    goal: { points: 220 },
    movesLimit: 32,
    blockCount: 5,
    iceCount: 4,
  ...
  },
  {
    id: 'level-10',
    title: 'Endspiel',
    description: '300 Punkte in 36 Zügen, brutaler Aufbau.',
    goal: { points: 300 },
    movesLimit: 36,
    blockCount: 6,
    iceCount: 5,
