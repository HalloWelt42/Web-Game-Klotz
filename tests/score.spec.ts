...
describe('scorePlacement', () => {
  ...
  it('gibt nur Basis-Punkte ohne Raumung', () => {
  ...
  it('vergibt Linien-Bonus bei einer Raumung', () => {
  ...
  it('aktiviert Combo-Multiplikator ab zweitem Raum-Zug', () => {
  ...
  it('cappt Combo-Multiplikator bei x3', () => {
    const r = scorePlacement(i3, 1, 0, 100);
    expect(r.comboMultiplier).toBe(3);
  });

  it('setzt Combo zurueck wenn nichts geraumt wurde', () => {
